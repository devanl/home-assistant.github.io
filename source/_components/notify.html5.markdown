...
Google has [a handy guide](https://developers.google.com/cloud-messaging/chrome/client) that goes into great detail about how to set up for pushing to Chrome. Once you have your GCM API Key and Sender ID in hand, plug them into your configuration as described above.
